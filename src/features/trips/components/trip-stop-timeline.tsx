        ...
        {stops.map((stop, index) => (
          ...
          >
            ...
            <div className="pb-7">
              ...
              <CityImage
                city={stop.city}
                className="mt-4 aspect-[16/9] w-full rounded-md"
              ...
              {stop.accommodation ? (
                <div className="mt-4 border-l-2 border-[#87a993] pl-3">
                  ...
                  <div className="mt-1 flex flex-wrap gap-x-4 gap-y-1 text-xs text-muted-foreground">
                    <span>
                      {stop.accommodation.nights}{" "}
                      {stop.accommodation.nights === 1 ? "night" : "nights"}
                    </span>
                    <span>
                      {formatEuroCents(stop.accommodation.amountCents)}
                    </span>
