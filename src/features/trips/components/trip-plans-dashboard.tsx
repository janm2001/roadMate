...
export function TripPlansDashboard({ tripPlans }: TripPlansDashboardProps) {
  return (
    <section aria-labelledby="trip-plans-heading">
      <div className="mb-6 flex items-end justify-between gap-4">
        <div>
          <p className="text-sm font-semibold text-[#3f6f55]">Ready to explore</p>
      ...
      {tripPlans.length > 0 ? (
        ...
        <div className="border-y py-12 text-center">
          <h2 className="text-lg font-semibold">No trip plans yet</h2>
